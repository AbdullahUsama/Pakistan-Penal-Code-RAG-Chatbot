...
#     try:
#         response_prompt = f"Based on this transcription: '{transcribed_text}', complete the request"
...
def transcribe_and_respond_with_gemini(audio_file_path):
    """
    ...
    try:
        ...
        message = HumanMessage(
            content=[
                {
                    "type": "text",
                    "text": "Please transcribe this audio and then provide a helpful response to the query or request in the audio."
                },
                {
                    "type": "media",
                    "mime_type": "audio/wav",
...
if __name__ == "__main__":
    while True:
        try:
            ...
            transcribe_and_respond_with_gemini(recorded_file)
